...
BOT_TOKEN = environ.get('BOT_TOKEN', '8023425595:AAF5Do6_bl3YBywvJh_wT5EkPHfrC9tp_NM')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
INSTA_CHANNEL = int(environ.get('INSTA_CHANNEL', '-1002616933542'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+3eyfMnGKc3BlMTg1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002489528366 -1002069400808 -1002251860287 -1002397280633 -1002297410701 -1002441627959 -1002348399921 -1002266219670').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://ajifilterbot.koyeb.app/")
